...
<body>
    ...
    (function () {
      ...
      async function generateItinerary() {
        ...
        const url = `http://tuklasnasugbu.com/api/recommend/?days=${formData.day}&budget=${formData.budget}&adults=${formData.adults}&children=${formData.children}&seniors=${formData.seniors}&preference=${userPreference}&start_date=${formData.start_date}&end_date=${formData.end_date}`;
